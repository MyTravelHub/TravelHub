...
//   // Function to render "N/A" when a property is not available
...
//           {renderProperty("Flight ICAO", flightData.flight_icao)}
//           {renderProperty("Departure Gate", flightData.dep_gate)}
//           {renderProperty("Departure City", flightData.dep_city)}
//           {renderProperty("Arrival City", flightData.arr_city)}
//           {renderProperty("Arrival Gate", flightData.arr_gate)}
//         </div>
//       )}
//     </div>
//   );
    ...
    <div className="flight-search">
      ...
      {flightData && (
        <div className="flight-details">
          {/* Display flight data here */}
          <h2>Flight Information</h2>
          <p>Flight ICAO: {flightData.flight_icao || 'N/A'}</p>
          <p>Departure Gate: {flightData.dep_gate || 'N/A'}</p>
          <p>Departure City: {flightData.dep_city || 'N/A'}</p>
          <p>Arrival City: {flightData.arr_city || 'N/A'}</p>
          <p>Arrival Gate: {flightData.arr_gate || 'N/A'}</p>
        </div>
      )}
    </div>
  );
